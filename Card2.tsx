    ...
    return (
        <View style={{ height: 110, width: '100%', backgroundColor: 'white', borderRadius: 5, flexDirection: 'row', margin: 5, elevation: 2 }}>
            ...
            <View style={{ flex: 1, marginLeft: 5, justifyContent: 'space-between' }}>
                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginRight: 5, marginTop: 5 }}><Text style={{ fontSize: 13, flex: 1, fontFamily: 'Suwannaphum-Regular' }}>{shopName}</Text>
                ...
                <Text style={{ fontSize: 10, fontFamily: 'Suwannaphum-Regular' }}>{description}</Text>
